...
struct RuntimePolicySourceTests {
    ...
    func vmlxPinIncludesRuntimeHardening() throws {
        ...
        let expectedRuntimeHardenedRevision = "041ccfcac46a04ef8d516977741949bba3f07013"
        ...
        #expect(
            ...
            "Osaurus must consume the pushed vmlx-swift runtime-hardening revision proven by the Qwen/Gemma/DSV4/Step matrix, Gemma4 proportional RoPE live rows, Gemma4 quoted tool-key parser coverage, Nemotron Ultra JANGTQ streaming plus BF16/weighted-MoE fast-path guards plus native XML required-tool metadata, the Nemotron Ultra resident/mmap cache-proof harness, mmap graph-breakdown documentation, and the Nemotron Ultra mamba_projection role alias; an internally-consistent older pin is still not wired"
        )
